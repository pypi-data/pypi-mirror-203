...
def save_vocab(savedir, name, field):
...
def save_field(savedir, name, field):
...
def main(args):
    ...
    save_field(output, 'src', TXT)
    save_vocab(output, 'src', TXT)
        ...
        with tqdm(total = len(train_dl) * train_dl.batch_size, 
            ...
            for idx, (x_train, y_train) in enumerate(train_dl):
                ...
                if args.save_interval:
                    ...
                    model_fname = os.path.join(output, f'model_last.pt')
