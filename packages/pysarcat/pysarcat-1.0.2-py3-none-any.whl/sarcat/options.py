...
def train_opts(parser):
    ...
    group.add_argument('--output', default='./results',
        help='location where to store model')
    group.add_argument('--category_dir', default='../data/',
        help='path to a train data')
    group.add_argument('--resume_from_path', default='../data/',
        help='location for model to restore')
    group.add_argument('--master_category_path', default='../data/mcat_dict.json',
        help='path to master categorty dict')
    group.add_argument('--batch_size', type=int, default=32, 
        help='batch size')
    group.add_argument('--lr', type=float, default=0.0006,
        help='learning rate')
    group.add_argument('--epochs', type=int, default=50, 
        help='epochs')
    group.add_argument('--max_seq_length', type=int, default=250,
        help='max_seq_length')
    ...
    group.add_argument('--save_interval', action='store_true',
        help='save a checkpoint every epoch')
    group.add_argument('--resume', action='store_true',
        help='resume training')
    group.add_argument('--save_dataset', action='store_true',
        help='save dataset')
    group.add_argument('--load_dataset', action='store_true',
        help='load dataset')
    ...
    group.add_argument('--wandb_name', type=str, default='artag',
...
def model_opts(parser):
    ...
    group.add_argument('--hidden_size', type=int, default=256,
        help='hidden size')
    group.add_argument('--model-name', type=str, default='allenai/scibert_scivocab_uncased',
