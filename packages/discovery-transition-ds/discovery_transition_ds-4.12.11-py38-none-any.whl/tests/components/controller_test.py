...
class ControllerTest(unittest.TestCase):
    ...
    def test_use_case(self):
        ...
        os.environ['HADRON_PROFILING_ORIGIN'] = "mysql://user:pass@localhost:3306/mydb?table=origin"
        os.environ['HADRON_PROFILING_OTHER'] = "mysql://user:pass@localhost:3306/mydb?table=other"
        os.environ['HADRON_ALIGN_ORIGIN'] = "mysql://user:pass@localhost:3306/mydb?table=mapping"
        os.environ['HADRON_ALIGN_OTHER'] = os.environ['HADRON_ALIGN_ORIGIN']
        os.environ['HADRON_DIFF_ON'] = 'date'

        controller = Controller.from_env(
            uri_pm_repo='https://raw.githubusercontent.com/project-hadron/hadron-asset-bank/master/contracts/commons/difference_report/')
