...
.. warn:: Do not use directly
    ...
    It should not be used directly except in behavecrackle Runner classes
...
import os.path
import sys
from behavecrackle import step_registry as _step_registry
# from behavecrackle import matchers as _matchers
import six
...
class FakeModule(ModuleType):
    ...
    # -- SUPPORT FOR: behavecrackle.step_registry.setup_step_decorators()
...
class StepRegistryModule(FakeModule):
    """Provides a fake :mod:`behavecrackle.step_registry` module
    ...
    def __init__(self, step_registry):
        super(StepRegistryModule, self).__init__("behavecrackle.step_registry")
...
class StepMatchersModule(FakeModule):
    ...
    def __init__(self, matcher_factory):
        super(StepMatchersModule, self).__init__("behavecrackle.matchers")
        ...
        self.__name__ = "behavecrackle.matchers"
...
class BehaveModule(FakeModule):
    ...
    def __init__(self, step_registry, matcher_factory=None):
        ...
        super(BehaveModule, self).__init__("behavecrackle")
        setup_api_with_step_decorators(self, step_registry)
        setup_api_with_matcher_functions(self, matcher_factory)
        self.use_default_step_matcher = matcher_factory.use_default_step_matcher
...
class StepImportModuleContext(object):
    ...
    def __init__(self, step_container):
        ...
        self.modules = {
            "behavecrackle": behave_module,
            "behavecrackle.matchers": step_matchers_module,
            "behavecrackle.step_registry": step_registry_module,
        }
...
def use_step_import_modules(step_container):
    ...
    (:mod:`behavecrackle.step_registry`, mod:`behavecrackle.matchers`).
