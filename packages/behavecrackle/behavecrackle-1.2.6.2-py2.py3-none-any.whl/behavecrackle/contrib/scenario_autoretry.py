...
behavecrackle tests in a unreliable server/network infrastructure.
...
.. sourcecode:: python
    ...
    from behavecrackle.contrib.scenario_autoretry import patch_scenario_with_autoretry
...
def patch_scenario_with_autoretry(scenario, max_attempts=3):
    """Monkey-patches :func:`~behavecrackle.model.Scenario.run()` to auto-retry a
