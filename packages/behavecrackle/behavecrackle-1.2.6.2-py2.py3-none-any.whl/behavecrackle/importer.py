...
from behavecrackle.exception import ClassNotFoundError, ModuleNotFoundError
...
def parse_scoped_name(scoped_name):
    ...
    EXAMPLE:
        behavecrackle.formatter.plain:PlainFormatter
    """
...
class LazyDict(dict):
    ...
    .. code-block:: python
        ...
        from behavecrackle.importer import LazyDict
