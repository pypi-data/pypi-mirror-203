# -*- coding: utf-8 -*-
"""
Provides textual descriptions for :mod:`behavecrackle.model` elements.
"""

from __future__ import absolute_import
from six.moves import range     # pylint: disable=redefined-builtin
from six.moves import zip       # pylint: disable=redefined-builtin
from behavecrackle.textutil import indent
...
class ModelDescriptor(object):
    ...
    def describe_table(table, indentation=None):
        ...
        :param table:  Table to use (as :class:`behavecrackle.model.Table`)
