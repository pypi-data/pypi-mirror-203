# -*- coding: utf-8 -*-
"""
Read behavecrackle's JSON output files and store retrieved information in
:mod:`behavecrackle.model` elements.

Utility to retrieve runtime information from behavecrackle's JSON output.
...
import codecs
from behavecrackle import model
...
def parse(json_filename, encoding="UTF-8"):
    """
    Reads behavecrackle JSON output file back in and stores information in
    behavecrackle model elements.
