...
import six
import sys
from behavecrackle.exception import ConstraintError
...
def require_min_python_version(minimal_version):
    ...
    :raises: behavecrackle.exception.ConstraintError
    """
...
def require_min_behave_version(minimal_version):
    """Simplifies to specify the minimal behavecrackle version that is required.
    ...
    if behave_version2 < minimal_version2:
        ...
        raise ConstraintError("behavecrackle >= %s expected (was: %s)" % \
