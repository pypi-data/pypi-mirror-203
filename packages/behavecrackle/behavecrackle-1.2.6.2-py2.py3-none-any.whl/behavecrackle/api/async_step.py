...
in a step-module with behavecrackle. This functionality simplifies to test
...
class AsyncContext(object):
    ...
    * which (asyncio) tasks are used or of interest
    ...
    .. attribute:: name
        ...
        Optional name of this object (in the behavecrackle context).
    ...
    .. code-block:: python
        ...
        from behavecrackle.api.async_step import AsyncContext
...
def use_or_create_async_context(context, name=None, loop=None, **kwargs):
    ...
    .. code-block:: python
        ...
        # -- FILE: features/steps/my_async_steps.py
        # EXAMPLE REQUIRES: Python 3.5
        from behavecrackle import when
        from behavecrackle.api.async_step import use_or_create_async_context
