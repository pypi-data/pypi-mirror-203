# -*- coding: utf-8 -*-
# =============================================================================
# SPHINX CONFIGURATION: behavecrackle documentation build configuration file
# =============================================================================
...
extlinks = {
    "behavecrackle": ("https://github.com/behave/behave", None),
    "behavecrackle.example": ("https://github.com/behave/behave.example", None),
...
from behavecrackle import __version__
version = __version__
...
htmlhelp_basename = "behavecrackle.doc"
...
latex_documents = [
  ("index", "behavecrackle.tex", u"behavecrackle Documentation", authors, "manual"),
]
...
man_pages = [
    ("index", "behavecrackle", u"behavecrackle Documentation", [authors], 1)
]
...
texinfo_documents = [
  ("index", "behavecrackle", u"behavecrackle Documentation", authors,
   "behavecrackle", "A test runner for behavecrackle (feature tests).", "Miscellaneous"),
]
