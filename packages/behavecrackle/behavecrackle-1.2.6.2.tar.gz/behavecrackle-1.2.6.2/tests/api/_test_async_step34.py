# -*- coding: UTF-8 -*-
"""
Unit tests for :mod:`behavecrackle.api.async_test`.
"""

# -- IMPORTS:
from __future__ import absolute_import, print_function
import sys
from behavecrackle.api.async_step import AsyncContext, use_or_create_async_context
from behavecrackle._stepimport import use_step_import_modules
from behavecrackle.runner import Context, Runner
...
class TestAsyncStepRunPy34(object):
    ...
    def test_async_step_passes(self):
        ...
        with use_step_import_modules(step_container):
            ...
            from behavecrackle import given, when
            from behavecrackle.api.async_step import async_run_until_complete
            import asyncio
