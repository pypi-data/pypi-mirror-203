...
from behavecrackle.model import ScenarioOutline, Scenario
from behavecrackle.model_core import Status
from behavecrackle.reporter.summary import SummaryReporter, format_summary
...
class TestSummaryReporter(object):
    ...
    @patch('sys.stdout')
    @patch('behavecrackle.reporter.summary.format_summary')
