...
:meth:`behavecrackle.runner.Context.add_cleanup()` method.
...
from behavecrackle.runner import Context, scoped_context_layer
...
class TestContextCleanupWithLayer(object):
    """Tests :meth:`behavecrackle.runner.Context.add_cleanup()`
