...
::
    Traceback (most recent call last):
      File "/usr/local/bin/behavecrackle", line 11, in <module>
        sys.exit(main())
      File "/usr/local/lib/python2.7/dist-packages/behavecrackle/__main__.py", line 109, in main
        failed = runner.run()
        ...
      File "/usr/local/lib/python2.7/dist-packages/behavecrackle/model.py", line 919, in run
        runner.run_hook('after_scenario', runner.context, self)
      File "/usr/local/lib/python2.7/dist-packages/behavecrackle/runner.py", line 405, in run_hook
        self.hooks[name](context, *args)
      File "/mnt/work/test/lib/logcapture.py", line 22, in f
        v = h.getvalue()
      File "/usr/local/lib/python2.7/dist-packages/behavecrackle/log_capture.py", line 99, in getvalue
...
from behavecrackle.log_capture import capture
