...
# RELATED-TO: #756
"""
Example code how to provide a behavecrackle fixture to disable the
background inheritance mechanism.

.. code-block:: gherkin

    # -- FILE: features/example.feature
    Feature: Show how @fixture.behavecrackle.override_background is used
        ...
        @fixture.behavecrackle.no_background
        Scenario: Bob
...
.. code-block:: python
    ...
    from behavecrackle.fixture import use_fixture_by_tag

    # -- FIXTURE REGISTRY:
    fixture_registry = {
        "fixture.behavecrackle.no_background": behave_override_background,
    }
...
from behavecrackle import fixture


# -----------------------------------------------------------------------------
# BEHAVE FIXTURES:
# -----------------------------------------------------------------------------
@fixture(name="fixture.behavecrackle.ono_background")
...
# -----------------------------------------------------------------------------
fixture_registry = {
    "fixture.behavecrackle.no_background": behave_no_background,
}
