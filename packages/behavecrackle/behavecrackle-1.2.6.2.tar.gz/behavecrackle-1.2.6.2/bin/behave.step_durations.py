...
# -*- coding: utf-8 -*-
"""
Utility script to retrieve duration information from behavecrackle JSON output.
...
# -- IMPORTS:
from behavecrackle import json_parser
...
Read behavecrackle JSON data file and extract steps with longest duration."""
