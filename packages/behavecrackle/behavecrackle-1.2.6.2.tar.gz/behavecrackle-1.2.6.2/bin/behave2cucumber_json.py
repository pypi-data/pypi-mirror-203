#!/usr/bin/env python
# =============================================================================
# CONVERT: behavecrackle JSON dialect to cucumber JSON dialect
# =============================================================================
...
# =============================================================================
"""
Convert a file with behavecrackle JSON data into a file with cucumber JSON data.
...
def convert_behave_to_cucumber_json(behave_filename, cucumber_filename,
    ...
    """Convert behavecrackle JSON dialect into cucumber JSON dialect.

    .. param behave_filename:       Input filename with behavecrackle JSON data.
...
def main(args=None):
    ...
    if len(args) != 2:
        ...
        print("Converts behavecrackle JSON dialect to cucumber JSON dialect.")
        return 1
