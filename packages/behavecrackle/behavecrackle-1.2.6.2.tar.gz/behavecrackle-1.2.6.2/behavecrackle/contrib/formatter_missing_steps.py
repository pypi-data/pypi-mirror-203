...
from behavecrackle.runner_util import make_undefined_step_snippets
from behavecrackle.formatter.steps import StepsUsageFormatter
...
class MissingStepsFormatter(StepsUsageFormatter):
    ...
    .. code-block:: ini
        ...
        behavecrackle.formatter.missing_steps.template = # -*- coding: {encoding} -*-
    ...
    scope = "behavecrackle.formatter.missing_steps"
