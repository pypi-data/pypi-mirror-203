...
from behavecrackle._types import ChainedExceptionUtil, ExceptionUtil
from behavecrackle.model_core import Argument, FileLocation, Replayable
...
class Match(Replayable):
    ...
    .. attribute:: arguments
       ...
       A list of :class:`~behavecrackle.model_core.Argument` instances containing the
...
class Matcher(object):
    ...
    def check_match(self, step):
        ...
        :class:`~behavecrackle.model_core.Argument` instances.

        The return value from this function will be converted into a
        :class:`~behavecrackle.matchers.Match` instance by *behavecrackle*.
        """
...
def register_type(**kw):
    ...
    .. code-block:: python
        ...
        from behavecrackle import register_type, given
        import parse
        ...
        # -- REGISTER TYPE-CONVERTER: With behavecrackle
...
matcher_mapping = {
    ...
    #   from behavecrackle import use_step_matcher
...
def use_step_matcher(name):
    ...
    There are several parsers available in *behavecrackle* (by default):
    ...
    **parse** (the default, based on: :pypi:`parse`)
        ...
        (see :func:`~behavecrackle.register_type()`).
