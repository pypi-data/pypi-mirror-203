...
Mapping of behavecrackle model elements to XML elements::
...
from behavecrackle.reporter.base import Reporter
from behavecrackle.model import Rule, Scenario, ScenarioOutline, Step
from behavecrackle.model_core import Status
from behavecrackle.formatter import ansi_escapes
from behavecrackle.model_describe import ModelDescriptor
from behavecrackle.textutil import indent, make_indentation, text as _text
from behavecrackle.userdata import UserDataNamespace
import six
if six.PY2:
...
class JUnitReporter(Reporter):
    """Generates JUnit-like XML test report for behavecrackle.
    """
    # -- XML REPORT:
    userdata_scope = "behavecrackle.reporter.junit"
    ...
    def setup_with_userdata(self, userdata):
        ...
        .. code-block:: ini
            ...
            [behavecrackle.userdata]
            behavecrackle.reporter.junit.show_hostname = false
        """
        # -- EXPERIMENTAL:
    ...
    def feature(self, feature):
        ...
        # -- SINCE: behavecrackle-1.2.6.dev0
