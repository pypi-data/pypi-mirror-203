...
class SignalTimeSlice(object):
    ...
    def __init__(self, received_at=None, updated_at=None, minutes_to_delivery=None, revision=None, locked=None, parameters=None, local_vars_configuration=None):  # noqa: E501
