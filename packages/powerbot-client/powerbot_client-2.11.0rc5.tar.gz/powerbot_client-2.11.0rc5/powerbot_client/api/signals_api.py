...
"""
    ...
    The version of the OpenAPI document: 2.11.0-rc5
...
class SignalsApi(object):
    ...
    def find_trading_signals(self, delivery_area, portfolio_id, **kwargs):  # noqa: E501
        ...
        :type limit: int
        :param include_historic: Setting this to `true` will also return deleted and old (overwritten) signal revisions. Cannot be combined with `active_only`.
        :type include_historic: bool
        :param active_only: Filter for only currently active time slices. Cannot be combined with `include_historic`.
