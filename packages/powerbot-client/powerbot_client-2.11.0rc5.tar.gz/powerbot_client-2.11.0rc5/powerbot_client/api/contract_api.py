...
class ContractApi(object):
    ...
    def get_order_books(self, **kwargs):  # noqa: E501
        ...
        :param past_hours: DEPRECATED: Please use `delivery_from` in combination with `active_only=false`. The number of hours to look into the past in the orderbook. If this parameter is set, historic closed contracts are contained in the orderbook as well.
        :type past_hours: int
