...
class AddressesApi(object):
    ...
    def get_rejection_advice(self, address_id, message_id, **kwargs):  # noqa: E501
        """get a rejected-message record  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rejection_advice(address_id, message_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_rejection_advice_with_http_info(address_id, message_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_rejection_advice_with_http_info(address_id, message_id, **kwargs)  # noqa: E501
            return data

    def get_rejection_advice_with_http_info(self, address_id, message_id, **kwargs):  # noqa: E501
        """get a rejected-message record  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rejection_advice_with_http_info(address_id, message_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_rejection_advice" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address_id' is set
        if ('address_id' not in params or
                params['address_id'] is None):
            raise ValueError("Missing the required parameter `address_id` when calling `get_rejection_advice`")  # noqa: E501
        # verify the required parameter 'message_id' is set
        if ('message_id' not in params or
                params['message_id'] is None):
            raise ValueError("Missing the required parameter `message_id` when calling `get_rejection_advice`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/addresses/{address_id}/outbound/rejection-advices/{message_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_rejection_advices(self, address_id, **kwargs):  # noqa: E501
        """get rejected-message records  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_rejection_advices(address_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_rejection_advices_with_http_info(address_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_rejection_advices_with_http_info(address_id, **kwargs)  # noqa: E501
            return data

    def list_rejection_advices_with_http_info(self, address_id, **kwargs):  # noqa: E501
        """get rejected-message records  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_rejection_advices_with_http_info(address_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_rejection_advices" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address_id' is set
        if ('address_id' not in params or
                params['address_id'] is None):
            raise ValueError("Missing the required parameter `address_id` when calling `list_rejection_advices`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/addresses/{address_id}/outbound/rejection-advices', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def select_accepted_message(self, address_id, message_id, **kwargs):  # noqa: E501
        """CHECK THIS get an accepted-message record  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.select_accepted_message(address_id, message_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.select_accepted_message_with_http_info(address_id, message_id, **kwargs)  # noqa: E501
        else:
            (data) = self.select_accepted_message_with_http_info(address_id, message_id, **kwargs)  # noqa: E501
            return data

    def select_accepted_message_with_http_info(self, address_id, message_id, **kwargs):  # noqa: E501
        """CHECK THIS get an accepted-message record  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.select_accepted_message_with_http_info(address_id, message_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/addresses/{address_id}/accepted-messages/{message_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
