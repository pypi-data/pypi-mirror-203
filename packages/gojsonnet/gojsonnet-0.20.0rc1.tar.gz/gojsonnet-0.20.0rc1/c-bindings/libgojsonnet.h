...
extern void jsonnet_fmt_indent(struct JsonnetVm* vmRef, int n);
extern void jsonnet_fmt_max_blank_lines(struct JsonnetVm* vmRef, int n);
extern void jsonnet_fmt_string(struct JsonnetVm* vmRef, int c);
extern void jsonnet_fmt_comment(struct JsonnetVm* vmRef, int c);
extern void jsonnet_fmt_pad_arrays(struct JsonnetVm* vmRef, int v);
extern void jsonnet_fmt_pad_objects(struct JsonnetVm* vmRef, int v);
extern void jsonnet_fmt_pretty_field_names(struct JsonnetVm* vmRef, int v);
extern void jsonnet_fmt_sort_imports(struct JsonnetVm* vmRef, int v);
extern char* jsonnet_fmt_snippet(struct JsonnetVm* vmRef, char* filename, char* code, int* e);
extern char* jsonnet_fmt_file(struct JsonnetVm* vmRef, char* filename, int* e);
extern void jsonnet_set_trace_out_callback(struct JsonnetVm* vmRef, JsonnetIoWriterCallback* cb);
extern char* jsonnet_realloc(struct JsonnetVm* vmRef, char* buf, size_t sz);
