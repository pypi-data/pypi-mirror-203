from typing import Any, Dict, Literal, TypedDict, Tuple, List, Union
...
class _BaseGen38037(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
