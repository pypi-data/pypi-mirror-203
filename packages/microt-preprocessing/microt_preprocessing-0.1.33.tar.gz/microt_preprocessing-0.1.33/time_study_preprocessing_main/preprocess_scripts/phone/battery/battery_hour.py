...
def get_battery_matrix_hour(df_minute):
    ...
    for hour in range(24):
        ...
        average_battery_level = df_subset.BATTERY_LEVEL.mean()
    ...
    df_hour = pd.DataFrame(
        {"YEAR_MONTH_DAY": ymd_list, "HOUR": hour_list, "AVERAGE_BATTERY_LEVEL": battery_ON_list, "CHARGING_MINUTES": CHARGING_STATUS_list, "MISSING_MINUTES": MISSING_list})
