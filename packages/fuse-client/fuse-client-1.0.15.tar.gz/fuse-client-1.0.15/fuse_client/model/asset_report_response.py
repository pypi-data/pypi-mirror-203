                        ...
                        class accounts(
                            ...
                            class MetaOapg:
                                ...
                                class items(
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["remote_account_id", "balances", "historical_balances", "transactions", ], str]):
                                        # dict_instance[name] accessor
                                        return super().__getitem__(name)
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["remote_account_id", "balances", "historical_balances", "transactions", ], str]):
                                        return super().get_item_oapg(name)
