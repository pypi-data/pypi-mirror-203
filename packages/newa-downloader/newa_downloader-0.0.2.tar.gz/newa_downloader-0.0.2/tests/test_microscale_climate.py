...
from newa_downloader.microscale import climate
...
valid_3d_v = ["wind_speed"]
valid_2d_v = ["elevation"]
invalid_3d_v = ["GARBAGE"]

@pytest.mark.parametrize(("var, coord, height"), [
...
def test_datapoint_download(tmp_path: Path,
    ...
    climate.download(file,var, coord, height)
