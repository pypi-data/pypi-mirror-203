...
def load_lib(module_factory, output_dir):
    ...
    include_path0 = os.path.join(source_dir, "install_nn2", "include")
    include_path1 = os.path.join(contrib_dir, "hhb", "install_nn2", "include")
    ref_x86_dir0 = os.path.join(source_dir, "install_nn2", "lib")  # for source
    ref_x86_dir1 = os.path.join(contrib_dir, "hhb", "install_nn2", "lib")  # for package binary
