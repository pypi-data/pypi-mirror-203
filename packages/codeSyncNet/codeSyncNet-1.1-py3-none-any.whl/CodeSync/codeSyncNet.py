...
class CodeSyncNet(nn.Module):
    ...
    def tokenize(self, code, docstring):
        source_tokens = self.tokenizer.tokenize(code)
        ...
        target_tokens = self.tokenizer.tokenize(docstring)
    ...
    def inference(self, code, docstring):
        ...
        if output_label == 0:
            print("UNMATCH!")
            pred_text = self.model.generate(code_ids)
