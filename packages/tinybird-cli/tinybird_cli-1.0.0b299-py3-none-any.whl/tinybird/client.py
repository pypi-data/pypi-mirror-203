...
class TinyB(object):
    ...
    async def branch_regression_tests(self, branch_id: str, pipes: Optional[List[str]], test_type: str, only_response_times: Optional[bool] = False,
                                      failfast: Optional[bool] = False, ignore_order: Optional[bool] = False, validate_processed_bytes: Optional[bool] = False,
