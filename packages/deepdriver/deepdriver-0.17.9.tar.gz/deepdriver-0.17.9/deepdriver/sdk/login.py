...
def login_with(key: str=None, id: str =None, pw: str=None, login_method: str=None):
    if login_method == "e":
        import getpass
    ...
    if key is None and id is None:
        ...
        if util.is_notebook():
            ...
            selected_login_method = widgets.Dropdown(
                options=[('--select--', 'n'), ('google', 'g'), ('email', 'e')],
                value='n',
            ...
            def on_change(change):
                if change['type'] == 'change' and change['name'] == 'value':
                    ...
                    login_with(key, id,pw, change['new'])
            ...
            login_with(key, id ,pw, login_with_google)
