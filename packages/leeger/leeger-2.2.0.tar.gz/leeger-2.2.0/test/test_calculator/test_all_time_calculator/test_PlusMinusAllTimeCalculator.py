...
class TestPlusMinusAllTimeCalculator(unittest.TestCase):
    ...
    def test_getPlusMinus_yearNumberStartGivenWeekNumberStartGiven(self):
        ...
        response = PlusMinusAllTimeCalculator.getPlusMinus(league, yearNumberStart=2001, weekNumberStart=2)
    ...
    def test_getPlusMinus_yearNumberEndGivenWeekNumberEndGiven(self):
        ...
        response = PlusMinusAllTimeCalculator.getPlusMinus(league, yearNumberEnd=2001, weekNumberEnd=2)
    ...
    def test_getPlusMinus_yearNumberStartGivenWeekNumberStartGivenAndYearNumberEndGivenWeekNumberEndGiven(self):
        owners, teamsA = getNDefaultOwnersAndTeams(6)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = PlusMinusAllTimeCalculator.getPlusMinus(league, yearNumberStart=2001, weekNumberStart=1,
