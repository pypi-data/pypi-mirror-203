...
class STEAM_materials:
    ...
    def evaluate(self, numpy2d):
        ...
        if error_out == 1:
            ...
            raise ValueError(f"There was a problem with calling {self.func_namec_name}.dll with arguments {numpy2d}. Check if dll file exists or if number of arguments is correct.")
