...
class SetSIMRecievedMobileTicketTestCase(unittest.TestCase):
    ...
    def test_run_only_mobile_confirm_doc(self, MockDF, MockOTRSClient, MockDate):
        ...
        MockOTRSClient.return_value.get_ticket_by_number.return_value.dynamic_field_get.return_value.value = "si" # noqa
    ...
    def test_run_only_mobile_no_confirm_doc(self, MockDF, MockOTRSClient, MockDate):
        ...
        MockOTRSClient.return_value.get_ticket_by_number.return_value.dynamic_field_get.return_value.value = "no" # noqa
        MockDate.today.return_value = date(2023,1,11)
        SetSIMRecievedMobileTicket(ticket_number, True, ANY, ANY, ANY, date(2023,1,20)).run()
        MockOTRSClient.return_value.get_ticket_by_number.assert_called_once_with(
            ticket_number,
            dynamic_fields=True,
        )
    ...
    def test_run_ended_fiber(self, MockDF, MockOTRSClient, MockDate):
        ...
        MockOTRSClient.return_value.get_ticket_by_number.return_value.tid = 321
        MockOTRSClient.return_value.get_ticket_by_number.return_value.field_get.return_value = 'Serveis mòbil::Provisió mòbil::01.1 Fibra finalitzada' # noqa
        MockDate.today.return_value = date(2023,1,11)
        SetSIMRecievedMobileTicket(ticket_number, ANY, ANY, ANY, date(2023,1,20)).run()
        MockOTRSClient.return_value.get_ticket_by_number.assert_called_once_with(
            ticket_number,
            dynamic_fields=True,
        )
    ...
    def test_run_not_associated_not_portability(self, MockDF, MockOTRSClient, MockDate):
        ...
        SetSIMRecievedMobileTicket(ticket_number, only_mobile, associated, portability, date(2023,1,20)).run()
