...
_colorThemeFunc1 = 0
_colorThemeFunc2 = 0
_colorBible = {"k": "", "v": "", "l": "", "d": "", "a": "", "o": "", "s": "", "2": "", "9": "", "1": "", "HIGHLIGHT_SEARCH": ""}
_themeNr = None
...
def set_locale(locale):
    ...
    if locale == "en":
        _resource = {
            ...
            "ERR_KJV2000_LIMIT_500": "No more than 500 verses (c) KJV2000, RVA1989, LND1991",
            "ERR_KJV2000_LIMIT_FULLBOOK": "No full book (c) KJV2000, RVA1989, LND1991",
            "FILTER": "Filter",
            "FOUND": "Found",
            "HELP": "Help",
            "KEYS": "Keys",
...
def show_bible_colors():
    ...
    dict_menu = get_bible_dict_verbose()
    dict_menu[10] = "(**) {0}".format(res("HIGHLIGHT_SEARCH"))
...
def generate_text_for_clipboard():
    try:
        ...
        for bib in range(0, len(bbnames_before_check)):
            ...
            if bbname_current_before_check in ("2", "9", "1"):
                warn_type = 0
...
def load_colors():
    ...
    _colorBible = {"k": color_k, "v": color_v, "l": color_l, "d": color_d, "a": color_a, "o": color_o, "s": color_s, "2": color_2, "9": color_9, "1": color_1, "HIGHLIGHT_SEARCH": color_highlight_search}
...
def load_config():
    ...
    _bbName = somconfig.get_option("PREFERENCES", "BIBLE_PREFERED", ("k", "v", "l", "d", "a", "o", "s", "2", "9", "1"), "k")
...
def main():
    ...
    try:
        ...
        function_keys_dict = {
            "1|M": res("MENU"),
            "2|{0}".format("B"): res("BOOKS"),
            "3|{0}".format("S"): res("SEARCH"),
            "4|{0}".format("F"): res("SEARCH_FAV"),
            "5|{0}".format("A"): res("ARTICLES"),
            "6|{0}".format("P"): res("PARABLES"),
            "7|Q": res("QUIT")
        }
        func_pos = 0
