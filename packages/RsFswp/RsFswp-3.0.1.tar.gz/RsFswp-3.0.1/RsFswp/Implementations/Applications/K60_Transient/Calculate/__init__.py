...
class CalculateCls:
	"""Calculate commands group definition. 74 total commands, 6 Subgroups, 0 group commands
	...
	def hopDetection(self):
		"""hopDetection commands group. 1 Sub-classes, 0 commands."""
	...
	def chrDetection(self):
		"""chrDetection commands group. 1 Sub-classes, 0 commands."""
