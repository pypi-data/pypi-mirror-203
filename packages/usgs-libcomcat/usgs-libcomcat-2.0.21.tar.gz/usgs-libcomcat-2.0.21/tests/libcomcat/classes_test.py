...
def test_detail_product_versions():
    ...
    first_origin_us_source = detail.getProducts("origin", source="us", version="first")[
        0
    ]
    last_origin_us_source = detail.getProducts("origin", source="us", version="last")[0]
...
def test_detail():
    ...
    first_shakemap = event.getProducts("shakemap", version="first", source="atlas")[0]
