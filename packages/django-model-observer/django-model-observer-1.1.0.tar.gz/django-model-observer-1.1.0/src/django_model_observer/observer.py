...
class ModelObserverBase(six.with_metaclass(SingletonMeta)):
    ...
    .. seealso::
       ...
       * :class:`~django_model_observer.ModelOnlyObserverMixin`
       * :class:`~django_model_observer.ModelDescendantsObserverMixin`
       * :class:`~django_model_observer.OriginalObjectMixin`
    """
    ...
    def _create_context(self, instance: Model) -> TContext:
    ...
    def _get_context(self, instance: Model) -> TContext:
    ...
    def _remove_context(self, instance: Model) -> None:
    ...
    def __init__(self):
        ...
        def wrapper(handler):
            def inner(instance: Model, sender: Type[Model], **kwargs):
    ...
    def observe(self, model: Type[Model]):
    ...
    @abstractmethod
    def _is_observable(self, model: Type[Model]) -> bool:
        """Возвращает ``True``, если модель находится под наблюдением.

        :rtype: bool
        """

    def __pre_save_handler(self, instance: Model, **kwargs):
    ...
    def __post_save_handler(self, instance: Model, **kwargs):
    ...
    def __pre_delete_handler(self, instance: Model, **kwargs):
    ...
    def __post_delete_handler(self, instance: Model, **kwargs):
