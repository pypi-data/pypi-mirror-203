...
"""Setup and package metadata for the Optimyzer API Client Package."""
...
setup(
    ...
    description="An API Client for Optimyzer",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://gitlab.com/gauss-ml-open/optimyzer-api-client",
