...
def test_convert_value_to_fielddata():
    ...
    assert convert_value_to_fielddata("classlist", [{"abc": "123"}]) == [{"abc": "123"}]
...
def test_convert_fielddata_to_value():
    ...
    assert convert_fielddata_to_value("boolean", True) == True
    assert convert_fielddata_to_value("code", "123") == "123"
    assert convert_fielddata_to_value("barcode", "123") == "123"
    assert convert_fielddata_to_value("class", {"abc": "123"}) == "{'abc': '123'}"
    assert (
