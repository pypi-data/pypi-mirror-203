...
from ra_engine.ml.classification import (
    ANN,
    GradientBoosting,
    RandomForest,
    SVM,
...
def test_svm():
    ...
    assert svm.predictions(as_df=True) is not None
...
def test_ann():
    ...
    print(ann.predictions(as_df=True))
    assert ann.predictions(as_df=True) is None
...
def test_naivebayes():
    ...
    print(df_train.head())
    print(df_pred.head())
    print(nb.predictions(as_df=True))
    assert nb.predictions(as_df=True) is None
