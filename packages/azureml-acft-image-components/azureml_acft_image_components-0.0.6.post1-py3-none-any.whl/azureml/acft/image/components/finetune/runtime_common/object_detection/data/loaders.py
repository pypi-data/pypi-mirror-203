...
from azureml.acft.image.components.finetune.runtime_common.object_detection.data.dataset_wrappers \
    import DatasetProcessingType
from azureml.acft.image.components.finetune.runtime_common.object_detection.data.tiling_distributed_sampler \
