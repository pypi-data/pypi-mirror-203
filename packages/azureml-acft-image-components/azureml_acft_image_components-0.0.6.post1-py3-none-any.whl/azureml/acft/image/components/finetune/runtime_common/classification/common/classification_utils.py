...
from azureml.acft.image.components.finetune.runtime_common.classification.common.constants import PackageInfo, \
    ModelLiterals, vit_batch_size_defaults, vit_mc_lrs, vit_ml_lrs
from azureml.acft.image.components.finetune.runtime_common.classification.models import ModelFactory
...
from azureml.acft.image.components.finetune.runtime_common.common.data_utils import \
