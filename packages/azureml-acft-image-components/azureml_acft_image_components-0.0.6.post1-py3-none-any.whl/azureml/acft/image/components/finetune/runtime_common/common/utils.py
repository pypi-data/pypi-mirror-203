...
from azureml.acft.image.components.finetune.runtime_common.classification.common.constants import \
    LoggingLiterals
from azureml.acft.image.components.finetune.runtime_common.classification.common.constants import \
    ModelNames as ic_ModelNames
from azureml.acft.image.components.finetune.runtime_common.common import distributed_utils
from azureml.acft.image.components.finetune.runtime_common.common.average_meter import AverageMeter
from azureml.acft.image.components.finetune.runtime_common.common.base_model_factory import \
    BaseModelFactory
...
from azureml.acft.image.components.finetune.runtime_common.common.errors import AutoMLVisionInternal
...
from azureml.acft.image.components.finetune.runtime_common.common.tiling_dataset_element import Tile
from azureml.acft.image.components.finetune.runtime_common.common.tiling_utils import \
    parse_tile_grid_size_str
from azureml.acft.image.components.finetune.runtime_common.object_detection.common.constants import \
...
def download_checkpoint_for_incremental_training(settings: Dict[str, Any]) -> None:
    ...
    if checkpoint_run_id:
        from azureml.acft.image.components.finetune.runtime_common.common.artifacts_utils import \
