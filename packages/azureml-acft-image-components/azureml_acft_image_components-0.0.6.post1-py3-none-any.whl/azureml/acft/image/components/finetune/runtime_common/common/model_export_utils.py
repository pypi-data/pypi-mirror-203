...
from azureml.acft.image.components.finetune.runtime_common.classification.models.base_model_wrapper import \
    BaseModelWrapper

from azureml.acft.common_components import get_logger_app
from azureml.acft.image.components.finetune.runtime_common.common import utils
from azureml.acft.image.components.finetune.runtime_common.common.constants import \
    (MLFlowSchemaLiterals, ScoringLiterals)
from azureml.acft.image.components.finetune.runtime_common.common.exceptions import \
    AutoMLVisionDataException
from azureml.acft.image.components.finetune.runtime_common.explainability.constants import (
    ExplainabilityDefaults, ExplainabilityLiterals, XAIPredictionLiterals)
from azureml.acft.image.components.finetune.runtime_common.explainability.methods import load_xai_method
from azureml.acft.image.components.finetune.runtime_common.explainability.utils import (
    base64_to_img, validate_xai_parameters)
from azureml.acft.image.components.finetune.runtime_common.object_detection.models.base_model_wrapper import \
    BaseObjectDetectionModelWrapper
from azureml.acft.image.components.finetune.runtime_common.object_detection_yolo.models.yolo_wrapper import \
    YoloV5Wrapper
...
def _get_scoring_method(task_type: str, is_yolo: Optional[bool] = False) -> Callable[..., None]:
    ...
    :rtype: Python method
    """
    from azureml.acft.image.components.finetune.runtime_common.classification.inference.score import \
        _score_with_model as _score_with_model_classifier
    from azureml.acft.image.components.finetune.runtime_common.object_detection.writers.score import \
        _score_with_model as _score_with_model_od
    from azureml.acft.image.components.finetune.runtime_common.object_detection_yolo.writers.score import \
...
def prepare_model_export(run: Run, output_dir: str, task_type: str,
    ...
    if save_as_mlflow:
        ...
        from azureml.acft.image.components.finetune.runtime_common.common.mlflow.mlflow_model_wrapper import \
...
def load_model(task_type: str,
    ...
    if task_type in shared_constants.Tasks.ALL_IMAGE_CLASSIFICATION:
        from azureml.acft.image.components.finetune.runtime_common.classification.common.classification_utils \
        ...
        from azureml.acft.image.components.finetune.runtime_common.object_detection.common.object_detection_utils \
