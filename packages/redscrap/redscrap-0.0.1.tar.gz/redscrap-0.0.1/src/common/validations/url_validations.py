...
class UrlValidations:
    ...
    def validate_if_url_is_a_valid_img_link(self, url: str, possible_base_urls: List[str]) -> Optional[bool]:
        ...
        mimetype_match = url.lower().endswith((".jpg", ".jpeg", ".png"))
        is_valid = None
        # and mimetype_match
    ...
    def validate_image_url(self, possible_base_urls: List[str], provided_url: str) -> bool:
        """
        This method validates if any of the URLs in an URL list is equal or starts with a provided URL.
        ...
        for url in possible_base_urls:
            # print(provided_url, url, provided_url.startswith(url))
