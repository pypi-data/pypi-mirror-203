...
class ImageDownloader:
    ...
    def download_img_url_list(self, subreddit_or_user, subreddit_or_user_threads_list, output_dir, log_mode, verbose):
        ...
        - subreddit_posts_list (dict): A dictionary containing a list of subreddit posts.
        ...
        for subreddit_ele in subreddit_or_user_threads_list.keys():
            ...
            if len(subreddit_thread_img_list) > 0:
                self.download_img_urls_sync(subreddit_ele, subreddit_thread_img_list, output_dir, verbose)
    ...
    def download_img_urls_sync(self, scrapped_subreddit: str, subreddits_img_list: List[str], directory: str,
        ...
        Args:
            subreddits_img_list:
            scrapped_subreddit (str): The name of the subreddit from which the images were scrapped.
            subreddit.
            directory:
        ...
        output_dir = Path("./{}/".format(directory) + scrapped_subreddit)
        ...
        try:
            ...
            for url in tqdm(
                ...
                if response.status_code == 200:
                    ...
                    output_file = output_dir / Path(urlparse(url).path).name
                    ...
                    if not output_file.exists():
                        ...
                        msg = "{} - Skipping: {} already exists in the target folder {}".format(
                            self.constants.cross_symbol, url, output_dir)
                        logger.debug(msg)
        finally:
            client.close()

        self.generate_download_report(output_dir, subreddits_img_list, failed_urls)
