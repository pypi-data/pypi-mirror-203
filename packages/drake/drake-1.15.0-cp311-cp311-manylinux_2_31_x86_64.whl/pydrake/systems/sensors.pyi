...
class CameraConfig:
    ...
    z_near: float
    def __init__(self, **kwargs) -> None: ...
    def MakeCameras(self) -> Tuple[pydrake.geometry.render.ColorRenderCamera,pydrake.geometry.render.DepthRenderCamera]: ...
...
class RgbdSensor(pydrake.systems.framework.LeafSystem):
    @overload
    def __init__(self, parent_id: pydrake.geometry.FrameId, X_PB: pydrake.math.RigidTransform, color_camera: pydrake.geometry.render.ColorRenderCamera, depth_camera: pydrake.geometry.render.DepthRenderCamera) -> None: ...
    @overload
    def __init__(self, parent_id: pydrake.geometry.FrameId, X_PB: pydrake.math.RigidTransform, depth_camera: pydrake.geometry.render.DepthRenderCamera, show_window: bool = ...) -> None: ...
