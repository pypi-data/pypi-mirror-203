...
def get_binned_pk2d(X_grid, Lx, Ly, Nx, Ny, Y_grid=None, weight_array=None, kbins=None):
    r"""
    Returns the Fourier frequencies.
...
def get_binned_pk_mu_nu(X_grid, Lx, Ly, Lz, Nx, Ny, Nz, modes="parallel", line_name="CII", nu_obs=None, dnu=None, Y_grid=None, weight_array=None, nbins=20, kbins=None ):
    r"""
    Returns the Fourier frequencies.
