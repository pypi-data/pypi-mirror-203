...
class cosmo:
    def __init__(self):
        ...
        self.halo_model_mdef = inp.astro_params["halo_model_mdef"]
    ...
    def hmf_setup(
        self, z, Mmin, Mmax, q_out="dndlnM", hmf_code="colossus", print_cosmo=False
    ):
        if hmf_code == "colossus":
            ...
            mfunc = mass_function.massFunction(
                Mh, z, mdef="fof", model="sheth99", q_out=q_out
            )

            # mfunc = mass_function.massFunction(Mh, z, mdef = 'vir', model='tinker10', q_out = q_out)
    ...
    def bias_dm(self, m, z):
        ...
        b = bias.haloBias(m, z=z, model="sheth01", mdef="fof")
        return b
