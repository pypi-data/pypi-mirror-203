...
# Call find_singularly_accesible_devices() to obtain the list of devices (ips)
devices = ns.find_singularly_accesible_devices(subnet1, subnet2, ignore_list=ignore_list)
