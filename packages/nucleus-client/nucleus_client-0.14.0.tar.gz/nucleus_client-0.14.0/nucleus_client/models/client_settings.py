...
class ClientSettings(object):
    ...
    def __init__(self, id=None, banner=None, client_upload_aws_access_key_id=None, client_upload_aws_secret_access_key=None, colors=None, dataset_metadata=None, features=None, field_metadata=None, nav_page_ids=None, partner_bundle=None, privacy_guard_message=None):  # noqa: E501
