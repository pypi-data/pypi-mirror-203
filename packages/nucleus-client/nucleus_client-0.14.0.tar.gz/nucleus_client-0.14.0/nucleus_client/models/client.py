...
class Client(object):
    ...
    def __init__(self, id=None, amity_key=None, banner=None, bundles=None, client_ids=None, code=None, colors=None, dataset_metadata=None, default_bundle=None, default_user=None, dt_u=None, features=None, field_metadata=None, integrations=None, is_partner=None, name=None, nav_page_ids=None, null_default_value=None, privacy_guard_message=None, schedule=None, short_name=None, sites=None, spark_conf=None, sso=None, status=None):  # noqa: E501
