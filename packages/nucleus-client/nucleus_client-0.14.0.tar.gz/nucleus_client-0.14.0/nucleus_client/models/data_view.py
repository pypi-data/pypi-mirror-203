...
class DataView(object):
    ...
    def __init__(self, all_dimensions=None, all_fields=None, client_id=None, columns=None, dataset=None, dimensions=None, exclude_future=None, filters=None, granularity=None, include_goals=None, intervals=None, limit=None, lookups=None, metrics=None, mode=None, query_type=None, sort=None, unique_limit=None):  # noqa: E501
