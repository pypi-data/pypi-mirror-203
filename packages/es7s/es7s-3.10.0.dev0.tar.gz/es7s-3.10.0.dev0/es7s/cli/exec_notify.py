...
from ._decorators import cli_pass_context, _catch_and_log_and_exit, cli_option, cli_argument, cli_command
...
@cli_command(__file__, short_help="create and send a notification")
@cli_argument("ident")
