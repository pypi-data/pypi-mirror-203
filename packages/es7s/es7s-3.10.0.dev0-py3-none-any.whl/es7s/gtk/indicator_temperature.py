...
class IndicatorTemperature(_BaseIndicator[TemperatureInfo]):
    def __init__(self):
        self._show_none = _BoolState(value=True)
        self._show_one = _BoolState(value=False)
        self._show_three = _BoolState(value=False)
    ...
    def _init_state(self):
        ...
        self._state_map.update(
            {
                RadioMenuItemConfig("None", separator_before=True): self._show_none,
                RadioMenuItemConfig("Current (°C)"): self._show_one,
                RadioMenuItemConfig("Extra (°C)"): self._show_three,
            }
        )
