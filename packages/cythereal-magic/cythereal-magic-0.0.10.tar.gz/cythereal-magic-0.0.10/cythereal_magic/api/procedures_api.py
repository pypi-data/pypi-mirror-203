...
class ProceduresApi(object):
    ...
    def bulk_procedure_operation_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['format', 'explain', 'download', 'filename', 'no_links', 'uri', 'page_count', 'page_size', 'skip_count', 'action']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_procedure_files(self, proc_hash, **kwargs):  # noqa: E501
        ...
        :param str read_mask:  Comma separated string containing a list of keys to include in the response. `*` returns all keys.  REGEX: `^(([\\w]+,?)*|\\*)$` 
        :param str expand_mask: Comma separated string containing a list of relation keys to `expand` and show the entire object inline.   REGEX: `^(([\\w]+,?)*|\\*)$`
        :return: EnvelopedProcedure200ExplainResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_procedure_files_with_http_info(self, proc_hash, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EnvelopedProcedure200ExplainResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
