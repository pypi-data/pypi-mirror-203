...
import six
from cythereal_magic.models.file_labels_schema import FileLabelsSchema  # noqa: F401,E501

class AllOfFileCategories(FileLabelsSchema):
    ...
    if hasattr(FileLabelsSchema, "swagger_types"):
        swagger_types.update(FileLabelsSchema.swagger_types)

    attribute_map = {
    }
    if hasattr(FileLabelsSchema, "attribute_map"):
        attribute_map.update(FileLabelsSchema.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileCategories - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileLabelsSchema.__init__(self, *args, **kwargs)
