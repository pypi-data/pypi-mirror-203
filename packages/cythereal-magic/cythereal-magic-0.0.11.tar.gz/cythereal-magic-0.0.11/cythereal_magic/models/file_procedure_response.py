...
class FileProcedureResponse(object):
    ...
    def __init__(self, example_procedure_count=1, hard_hash='ecb50f092ebeeac4cf7804f8273d90e1', example_start_ea='0x1000', example_end_ea='0x101d', is_library=False, example_procedure_id='ce46741bf67591f5f60b7a74dec3ef8d648ca9c6/0x1000', status='clone', byte_counts=None, occurrence_counts=9, name_counts=9, coverage=1, signature_count=3, example_block_eas=None, procedure_names=None):  # noqa: E501
