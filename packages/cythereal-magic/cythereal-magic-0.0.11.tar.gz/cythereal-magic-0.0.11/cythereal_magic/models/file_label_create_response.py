...
class FileLabelCreateResponse(object):
    ...
    def __init__(self, success=True, status=201, message='Resource Created', errors=None, links=None, _self='https://api.magic.cythereal.com/v2/files/ce46741bf67591f5f60b7a74dec3ef8d648ca9c6', job_id='6d4a1164-7e4f-4bdd-951f-d302ef07f12a'):  # noqa: E501
