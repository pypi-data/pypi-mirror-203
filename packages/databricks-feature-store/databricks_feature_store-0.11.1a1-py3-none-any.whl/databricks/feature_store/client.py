...
class FeatureStoreClient:
    ...
    def __init__(
        ...
        self._unity_catalog_client = UnityCatalogClient(
        ...
        self._training_scoring_client = TrainingScoringClient(
            catalog_client=self._catalog_client,
            catalog_client_helper=self._catalog_client_helper,
            unity_catalog_client=self._unity_catalog_client,
            spark_client=self._spark_client,
    ...
    def create_training_set(
        ...
        # TODO (ML-29844): Determine if fully qualified UDF names should be resolved here or validated here
