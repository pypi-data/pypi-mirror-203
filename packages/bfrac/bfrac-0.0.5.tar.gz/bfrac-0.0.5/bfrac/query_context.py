...
class QueryContext:
    ...
    def set_region_server(self, in_region_server: Literal[
    ...
    def get_matches(self, in_count: int, in_type: Literal["ranked", "normal", "tourney", "tutorial"] = "",
    ...
    def get_all_matches(self, in_type: Literal["ranked", "normal", "tourney", "tutorial"],
                        in_queue: int, in_start_time: int, in_end_time: int) -> List[str]:
        """
