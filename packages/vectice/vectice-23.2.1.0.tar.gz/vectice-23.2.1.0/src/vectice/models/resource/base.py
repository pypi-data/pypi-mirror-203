...
class Resource(metaclass=ABCMeta):
    ...
    Examples:
        ...
        from vectice.models.resource.metadata import DatasetSourceOrigin, FilesMetadata
    ...
    def __init__(self):
        ...
        self._data: dict[str, bytes] | dict[str, Table | None] | None = None

    @property
    def data(self) -> dict[str, bytes] | dict[str, Table | None]:
        """The resource's data.
    ...
    @abstractmethod
    def _fetch_data(self) -> dict[str, bytes] | dict[str, Table | None]:
        pass
