...
def write_to_excel(ps_project_name, ps_designer, ps_date, ps_note,
    ...
    a, b, c, d, e, f, g, h, thd_offset_ccw_dir_add, rpm, pf, rd, root_option, gear_rot_dir, solid_shaft_flag, integral_crank_connector_flag,
    ...
    wt_bush_rkr, wt_bush_d_s, wt_bush_gear, bore_in_bore, rkr_cc_hit, high_vel, rd_act,
