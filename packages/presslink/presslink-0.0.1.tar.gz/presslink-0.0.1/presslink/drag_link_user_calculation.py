...
import math
from drag_link_modular import ModularDragLink
from pretty_graph_datagen import PrettyGraph
from drag_link_rocker_force import get_rocker_dic
import drag_link_sizer
from datetime import datetime
from drag_link_graph_plot import get_graphs
from drag_link_excel_writer import write_to_excel
import diff_list
from diff_peak_remover import peak_remover
...
# press data
pf = 800  # press force ton
rd = 12.7  # rated dist in mm
rpm = 50  # press rpm
f = 200  # ecc (half of press stroke)
g = 1200  # conrod
h = 0  # slide offset x
...
sizer_obj = drag_link_sizer.DragLinkSizer(a, b, c, d, e, thbc_min, 
    fb_max, trq, w, solid_shaft_flag, integral_crank_connector_flag)
...
if write_excel_file_flag:
    write_to_excel(ps_project_name, ps_designer, ps_date, ps_note,  # ws0
        ...
        GEAR_ROT_DIR, solid_shaft_flag, integral_crank_connector_flag,  # ws4 line 2
        ...
        wt_bush_rkr, wt_bush_d_s, wt_bush_gear, bore_in_bore, rkr_cc_hit, high_vel, rd_act,  # ws5 line 4
