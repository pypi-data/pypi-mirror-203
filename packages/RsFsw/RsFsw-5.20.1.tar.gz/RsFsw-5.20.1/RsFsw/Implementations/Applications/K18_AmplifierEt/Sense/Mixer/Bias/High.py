...
class HighCls:
	...
	def set(self, arg_0: float) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.sense.mixer.bias.high.set(arg_0 = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:BIAS:HIGH \n
		Snippet: value: float = driver.applications.k18AmplifierEt.sense.mixer.bias.high.get() \n
		No command help available \n
