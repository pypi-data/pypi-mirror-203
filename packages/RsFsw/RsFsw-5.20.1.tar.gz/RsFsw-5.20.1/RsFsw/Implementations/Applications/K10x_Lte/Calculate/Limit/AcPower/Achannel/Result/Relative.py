...
class RelativeCls:
	...
	def get(self, window=repcap.Window.Default, limitIx=repcap.LimitIx.Default) -> Results:
		...
		Snippet: value: Results = driver.applications.k10Xlte.calculate.limit.acPower.achannel.result.relative.get(window = repcap.Window.Default, limitIx = repcap.LimitIx.Default) \n
