...
class AcPairsCls:
	...
	def set(self, channel_pairs: float) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.power.achannel.acPairs.set(channel_pairs = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:POWer:ACHannel:ACPairs \n
		Snippet: value: float = driver.applications.k14Xnr5G.sense.power.achannel.acPairs.get() \n
		No command help available \n
