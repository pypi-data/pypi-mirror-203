...
class SsetupCls:
	...
	def set(self, state: bool, subBlock=repcap.SubBlock.Default) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.espectrum.ssetup.set(state = False, subBlock = repcap.SubBlock.Default) \n
	...
	def get(self, subBlock=repcap.SubBlock.Default) -> bool:
		"""SCPI: [SENSe]:ESPectrum<sb>:SSETup \n
		Snippet: value: bool = driver.applications.k14Xnr5G.sense.espectrum.ssetup.get(subBlock = repcap.SubBlock.Default) \n
		No command help available \n
			:param subBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Espectrum')
