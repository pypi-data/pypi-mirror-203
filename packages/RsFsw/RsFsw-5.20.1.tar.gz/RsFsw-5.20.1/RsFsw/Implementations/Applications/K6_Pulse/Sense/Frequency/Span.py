...
class SpanCls:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k6Pulse.sense.frequency.span.set(frequency = 1.0) \n
		This command defines the frequency span. \n
			:param frequency: Range: 80 Hz to depends on options installed, Unit: Hz
		"""
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:FREQuency:SPAN \n
		Snippet: value: float = driver.applications.k6Pulse.sense.frequency.span.get() \n
		This command defines the frequency span. \n
