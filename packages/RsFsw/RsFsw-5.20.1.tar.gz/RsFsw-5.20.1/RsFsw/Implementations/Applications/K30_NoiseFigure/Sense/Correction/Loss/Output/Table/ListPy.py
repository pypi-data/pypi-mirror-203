...
class ListPyCls:
	...
	def get(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.applications.k30NoiseFigure.sense.correction.loss.output.table.listPy.get() \n
		This command queries all output loss tables available in the application. \n
			:return: result: No help available"""
		response = self._core.io.query_str(f'SENSe:CORRection:LOSS:OUTPut:TABLe:LIST?')
