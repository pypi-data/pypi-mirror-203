...
class CalculateCls:
	"""Calculate commands group definition. 360 total commands, 22 Subgroups, 0 group commands
	...
	def tline(self):
		...
		if not hasattr(self, '_tline'):
			from .Tline import TlineCls
			self._tline = TlineCls(self._core, self._cmd_group)
		return self._tline
