...
class DtimeCls:
	...
	def set(self, dropout_time: float) -> None:
		...
		the 'Analog Baseband' interface (R&S FSW-B71) using the baseband power trigger (BBP) , the default drop out time is set
		to 100 ns to avoid unintentional trigger events (as no hysteresis can be configured in this case) . \n
