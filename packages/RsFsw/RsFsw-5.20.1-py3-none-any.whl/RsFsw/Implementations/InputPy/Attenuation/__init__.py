...
class AttenuationCls:
	...
	@property
	def auto(self):
		"""auto commands group. 1 Sub-classes, 1 commands."""
	...
	def set(self, attenuation: float) -> None:
		...
		command also adjusts the reference level. If an external frontend is active (see [SENSe:]EFRontend<fe>[:STATe]) , you can
		configure the attenuation of the external frontend and the analyzer separately. See also method RsFsw.InputPy.Sanalyzer.
		Attenuation.Auto.set and method RsFsw.InputPy.Sanalyzer.Attenuation.set. This function is not available if the optional
