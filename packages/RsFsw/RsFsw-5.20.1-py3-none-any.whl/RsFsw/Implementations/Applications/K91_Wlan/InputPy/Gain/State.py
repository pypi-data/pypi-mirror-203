...
class StateCls:
	...
	def set(self, state: bool, inputIx=repcap.InputIx.Default) -> None:
		...
		This function is not available for input from the optional 'Digital Baseband' interface. If option R&S FSW-B22 is
		installed, the preamplifier is only active below 7 GHz. If option R&S FSW-B24 is installed, the preamplifier is active
		for all frequencies. \n
