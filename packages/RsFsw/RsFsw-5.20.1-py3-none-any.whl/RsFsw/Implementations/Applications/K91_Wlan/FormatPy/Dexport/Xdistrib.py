...
class XdistribCls:
	...
	def set(self, xdistribution: enums.Xdistribution) -> None:
		...
		Snippet: driver.applications.k91Wlan.formatPy.dexport.xdistrib.set(xdistribution = enums.Xdistribution.BINCentered) \n
	...
	def get(self) -> enums.Xdistribution:
		"""SCPI: FORMat:DEXPort:XDIStrib \n
		Snippet: value: enums.Xdistribution = driver.applications.k91Wlan.formatPy.dexport.xdistrib.get() \n
		No command help available \n
