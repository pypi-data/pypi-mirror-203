...
class AgChannelsCls:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.power.achannel.agChannels.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: [SENSe]:POWer:ACHannel:AGCHannels \n
		Snippet: value: bool = driver.applications.k10Xlte.sense.power.achannel.agChannels.get() \n
		No command help available \n
