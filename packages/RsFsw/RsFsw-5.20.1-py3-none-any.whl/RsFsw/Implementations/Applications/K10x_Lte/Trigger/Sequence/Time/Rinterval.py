...
class RintervalCls:
	...
	def set(self, interval: float) -> None:
		...
		Snippet: driver.applications.k10Xlte.trigger.sequence.time.rinterval.set(interval = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: TRIGger[:SEQuence]:TIME:RINTerval \n
		Snippet: value: float = driver.applications.k10Xlte.trigger.sequence.time.rinterval.get() \n
		No command help available \n
