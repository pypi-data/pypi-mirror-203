...
class AbsoluteCls:
	...
	def get(self, window=repcap.Window.Default, limitIx=repcap.LimitIx.Default, channel=repcap.Channel.Default) -> Results:
		...
		Snippet: value: Results = driver.applications.k10Xlte.calculate.limit.acPower.alternate.result.absolute.get(window = repcap.Window.Default, limitIx = repcap.LimitIx.Default, channel = repcap.Channel.Default) \n
