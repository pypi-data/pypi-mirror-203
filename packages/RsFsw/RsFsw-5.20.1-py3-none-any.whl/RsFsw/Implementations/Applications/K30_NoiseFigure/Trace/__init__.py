...
class TraceCls:
	...
	def copy(self, target_trace: enums.TraceTypeK30, source_trace: enums.TraceTypeK30, window=repcap.Window.Default) -> None:
		"""SCPI: TRACe<n>:COPY \n
		Snippet: driver.applications.k30NoiseFigure.trace.copy(target_trace = enums.TraceTypeK30.TRACe1, source_trace = enums.TraceTypeK30.TRACe1, window = repcap.Window.Default) \n
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('target_trace', target_trace, DataType.Enum, enums.TraceTypeK30), ArgSingle('source_trace', source_trace, DataType.Enum, enums.TraceTypeK30))
