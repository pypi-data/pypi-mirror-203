...
class RsFsw:
	"""9027 total commands, 24 Subgroups, 1 group commands"""
	_driver_options = "SupportedInstrModels = FSW/FSWP/FSV/FSVR/FSVA, SupportedIdnPatterns = FSW/FSWP/FSV/FSVA/FSVR, SimulationIdnString = Rohde&Schwarz*FSW85*100001*5.20.1.0214"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '5.20.1.0214'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.20.1.0214'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsFsw version failed. Current version: '5.20.1.0214', minimum required version: '{min_version}'")
	...
	@property
	def system(self):
		"""system commands group. 30 Sub-classes, 0 commands."""
	...
	def calibration(self):
		"""calibration commands group. 7 Sub-classes, 0 commands."""
