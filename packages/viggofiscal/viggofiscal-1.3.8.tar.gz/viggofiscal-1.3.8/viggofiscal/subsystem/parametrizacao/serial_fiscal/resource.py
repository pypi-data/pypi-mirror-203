...
class SerieFiscal(entity.Entity, db.Model):
    ...
    attributes = ['domain_org_id', 'ambiente', 'modelo', 'serie',
                  ...
                  'codigo_seguranca_contribuinte_id']
    attributes += entity.Entity.attributes

    domain_org_id = db.Column(
        db.CHAR(32), db.ForeignKey('domain_org.id'), nullable=False)
    codigo_seguranca_contribuinte_id = db.Column(
        db.CHAR(32), db.ForeignKey('codigo_seguranca_contribuinte.id'),
        nullable=True)
    ...
    codigo_seguranca_contribuinte = orm.relationship(
        'CodigoSegurancaContribuinte',
        backref=orm.backref('serie_fiscal_codigo_seguranca_contribuinte'))
    ...
    def __init__(self, id, domain_org_id, ambiente, modelo, serie,
                 ultimo_doc, status, codigo_seguranca_contribuinte_id=None,
        ...
        self.status = status
        self.codigo_seguranca_contribuinte_id = codigo_seguranca_contribuinte_id
