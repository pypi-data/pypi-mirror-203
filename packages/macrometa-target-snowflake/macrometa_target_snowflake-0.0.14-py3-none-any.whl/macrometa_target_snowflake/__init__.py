    ...
    def config(self) -> List[ConfigProperty]:
        ...
        return [
            ...
            ConfigProperty('flush_all_streams', 'Flush All Streams', ConfigAttributeType.BOOLEAN, False, False,
                           description='Indicates whether to flush all streams (optional).',
                           default_value='false'),
            ConfigProperty('parallelism', 'Parallelism', ConfigAttributeType.INT, False, False,
                           description='Number of parallel threads (optional).',
                           default_value='1'),
            ConfigProperty('parallelism_max', 'Parallelism Max', ConfigAttributeType.INT, False, False,
                           description='Maximum number of parallel threads (optional).',
                           default_value='10')
        ]
