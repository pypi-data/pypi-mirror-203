"""
This file is used to generate message,signal,environment_variables Enum class.
...
for i in range(retry_times):
    try:
        ...
        print(project_name)
        dbc = parse_canoe_tools.CANoeToolHandler(project_name)
        dbc.write_msg_sig_to_enum_class(project_name)
        break
