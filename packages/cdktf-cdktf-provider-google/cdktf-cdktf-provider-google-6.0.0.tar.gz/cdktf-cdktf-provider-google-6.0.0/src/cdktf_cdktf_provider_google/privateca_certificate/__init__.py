...
class PrivatecaCertificateConfigAOutputReference(
    ...
    def put_x509_config(
        ...
        *,
        ...
        :param name_constraints: name_constraints block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google/r/privateca_certificate#name_constraints PrivatecaCertificate#name_constraints}
...
class PrivatecaCertificateConfigX509ConfigNameConstraints:
    def __init__(
        ...
        *,
        ...
        :param excluded_ip_ranges: Contains the excluded IP ranges. For IPv4 addresses, the ranges are expressed using CIDR notation as specified in RFC 4632. For IPv6 addresses, the ranges are expressed in similar encoding as IPv4 addresses. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google/r/privateca_certificate#excluded_ip_ranges PrivatecaCertificate#excluded_ip_ranges}
