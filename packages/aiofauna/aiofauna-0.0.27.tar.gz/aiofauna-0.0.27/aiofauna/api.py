...
from aiofauna.json import FaunaJSONEncoder as JSONEncoder, to_json, parse_json_or_none
...
async def extract_parameters(request: Request, params: dict):
    ...
    for name, param in params.items():
        ...
        if type_ in (str, int, float, bool) and name in request.match_info:
            ...
            args_to_apply[name] = type_(**json.loads(data, object_hook=parse_json_or_none))
