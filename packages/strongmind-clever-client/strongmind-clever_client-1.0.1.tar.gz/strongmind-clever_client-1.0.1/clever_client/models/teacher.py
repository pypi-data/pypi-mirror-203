...
class Teacher(object):
    ...
    def __init__(self, legacy_id=None, created=None, credentials=None, district=None, last_modified=None, name=None, school=None, schools=None, sis_id=None, state_id=None, teacher_number=None, title=None, ext=None, _configuration=None):  # noqa: E501
