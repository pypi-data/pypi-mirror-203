        ...
        return queryset.prefetch_related(
            Prefetch(
                ...
                queryset=ProductVariant.objects.filter(
                    ...
                    inventories__snooze_end_date__lte=now(),
                ).distinct(),
            ),
        ).distinct()
    ...
    def get_object(self):
        ...
        try:
            product_queryset = Product.objects.filter(
                ...
                product_variants__inventories__snooze_end_date__lte=now(),
                is_active=True,
            )
            instance = self.queryset.prefetch_related(
                Prefetch(
                    ...
                    queryset=Category.objects.filter(
                        ...
                        products__product_variants__inventories__snooze_end_date__lte=now(),
                    ).distinct(),
                ),
                Prefetch(
