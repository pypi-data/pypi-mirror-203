    ...
    def get_object(self):
        ...
        try:
            product_queryset = (
                ...
                .exclude(
                    product_variants__inventories__snooze_start_date__lte=now(),
                    product_variants__inventories__snooze_end_date__gte=now(),
                )
                .distinct()
            )
            instance = self.queryset.prefetch_related(
                Prefetch(
                    ...
                    .exclude(
                        products__product_variants__inventories__snooze_start_date__lte=now(),
                        products__product_variants__inventories__snooze_end_date__gte=now(),
                    )
                    .distinct(),
                ),
                Prefetch(
