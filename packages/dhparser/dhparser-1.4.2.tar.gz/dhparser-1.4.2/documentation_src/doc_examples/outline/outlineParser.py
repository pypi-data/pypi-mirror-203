...
class outlineGrammar(Grammar):
    ...
    """
    source_hash__ = "a2ab40f66ff3a02ed9e2c125ab303d45"
    ...
    s6section = Series(Option(WS), Drop(Text("######")), NegativeLookahead(Drop(Text("#"))), heading, Option(blocks), ZeroOrMore(NEVER_MATCH))
    s6sections = OneOrMore(Series(Option(WS), s6section))
    s5section = Series(Option(WS), Drop(Text("#####")), NegativeLookahead(Drop(Text("#"))), heading, Option(blocks), ZeroOrMore(s6sections))
    s5sections = OneOrMore(Series(Option(WS), s5section))
    subsubsection = Series(Option(WS), Drop(Text("####")), NegativeLookahead(Drop(Text("#"))), heading, Option(blocks), ZeroOrMore(s5sections))
    subsubsections = OneOrMore(Series(Option(WS), subsubsection))
    subsection = Series(Option(WS), Drop(Text("###")), NegativeLookahead(Drop(Text("#"))), heading, Option(blocks), ZeroOrMore(subsubsections))
    subsections = OneOrMore(Series(Option(WS), subsection))
    section = Series(Option(WS), Drop(Text("##")), NegativeLookahead(Drop(Text("#"))), heading, Option(blocks), ZeroOrMore(subsections))
    sections = OneOrMore(Series(Option(WS), section))
    main = Series(Option(WS), Drop(Text("#")), NegativeLookahead(Drop(Text("#"))), heading, Option(blocks), ZeroOrMore(sections))
...
class outlineCompiler(Compiler):
    ...
    # def on_s5sections(self, node):
    #     return node

    # def on_s5section(self, node):
    #     return node

    # def on_s6sections(self, node):
    #     return node
