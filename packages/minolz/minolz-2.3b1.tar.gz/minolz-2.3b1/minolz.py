...
Download utility as an easy way to get file from the net
  ...
  python -m minolz <URL>
  python minolz.py <URL>

minolz.py is not option compatible with Unix minolz utility,
to make command line interface intuitive for new people.

Public domain by anatoly techtonik <techtonik@gmail.com>
Also available under the terms of MIT license
Copyright (c) 2020-2024 anatoly techtonik
"""
...
if __name__ == "__main__":
    ...
    if "--version" in sys.argv:
        sys.exit("minolz.py " + __version__)
