...
class Mainwindow(QMainWindow):
    def __init__(self, app):
        ...
        super().__init__()
        self.palettes = [
            palette.Palette("palette10",
                            [QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor()]),
            palette.Palette("palette11",
                            [QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor()]),
            palette.Palette("palette12",
                            [QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor()]),
            palette.Palette("palette13",
                            [QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor()]),
            palette.Palette("palette14",
                            [QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor()]),
            palette.Palette("palette15",
                            [QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor()]),
            palette.Palette("palette16",
                            [QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor()]),
            palette.Palette("palette17",
                            [QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor(), QColor()])
        ]
        Palette.main = self
        self.app = app
