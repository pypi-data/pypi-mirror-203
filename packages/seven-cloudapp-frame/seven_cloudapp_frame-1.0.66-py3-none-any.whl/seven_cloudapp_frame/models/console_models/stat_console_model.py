        ...
        while True:
            try:
                ...
                try:
                    ...
                    stat_report_model = StatReportModel(db_transaction=db_transaction)
                    stat_orm = stat_orm_model.get_cache_entity("((act_id=%s and module_id=%s and object_id=%s) or (act_id=0 and module_id=0 and object_id='')) and key_name=%s", params=[stat_queue_dict["act_id"], stat_queue_dict["module_id"], stat_queue_dict["object_id"], stat_queue_dict["key_name"]])
                    if not stat_orm:
                    ...
                    if stat_orm.repeat_type > 0:
                        if stat_orm.repeat_type == 2:
                            stat_log_dict = stat_log_model.get_dict("act_id=%s and module_id=%s and orm_id=%s and user_id=%s and object_id=%s", field="id", params=[stat_queue_dict["act_id"], stat_queue_dict["module_id"], stat_orm.id, stat_queue_dict["user_id"], stat_queue_dict["object_id"]])
                        else:
                            stat_log_dict = stat_log_model.get_dict("act_id=%s and module_id=%s and orm_id=%s and user_id=%s and create_day=%s and object_id=%s", field="id", params=[stat_queue_dict["act_id"], stat_queue_dict["module_id"], stat_orm.id, stat_queue_dict["user_id"], create_day_int, stat_queue_dict["object_id"]])
                        if stat_log_dict:
                            is_add = False
                    ...
                    stat_log.object_id = stat_queue_dict["object_id"]
                    stat_log.orm_id = stat_orm.id
                    ...
                    stat_report_condition = "act_id=%s and module_id=%s and object_id=%s and key_name=%s and create_day=%s"
                    stat_report_param = [stat_queue_dict["act_id"], stat_queue_dict["module_id"], stat_queue_dict["object_id"], stat_queue_dict["key_name"], create_day_int]
                    stat_report_dict = stat_report_model.get_dict(stat_report_condition, params=stat_report_param)
                    ...
                    if is_add:
                        ...
                        if not stat_report_dict:
                            ...
                            stat_report.object_id = stat_queue_dict["object_id"]
