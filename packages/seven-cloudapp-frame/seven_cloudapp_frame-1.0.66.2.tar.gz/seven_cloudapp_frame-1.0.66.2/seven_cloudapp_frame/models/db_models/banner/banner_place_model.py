...
class BannerPlace:
    ...
    def __init__(self):
        super(BannerPlace, self).__init__()
        self.id = 0  # id
    ...
    def get_field_list(self):
        return ['id', 'product_id', 'place_name', 'place_pic', 'bottom_desc', 'sort_index', 'is_release', 'release_date', 'create_date', 'modify_date']
