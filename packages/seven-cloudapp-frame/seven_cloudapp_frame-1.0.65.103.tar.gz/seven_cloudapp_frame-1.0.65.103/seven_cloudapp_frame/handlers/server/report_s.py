...
@LastEditTime: 2023-02-16 15:42:06
...
class StatReportListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        stat_report_list = stat_base_model.get_stat_report_list(app_id, act_id, module_id, start_date, end_date, order_by, is_only_module, orm_condition, orm_params, report_condition, report_params)
        ref_params = {}
...
class TrendReportListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        stat_base_model = StatBaseModel(context=self)
        trend_report_list = stat_base_model.get_trend_report_list(app_id, act_id, module_id, start_date, end_date, order_by, is_only_module, orm_condition, orm_params, report_condition, report_params)
        ref_params = {}
