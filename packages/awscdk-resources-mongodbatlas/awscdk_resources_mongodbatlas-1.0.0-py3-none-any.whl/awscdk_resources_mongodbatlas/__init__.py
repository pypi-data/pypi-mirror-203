...
class CfnDatabaseUser(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param database_name: MongoDB database against which the MongoDB database user authenticates. MongoDB database users must provide both a username and authentication database to log into MongoDB.
        :param project_id: Unique identifier of the Atlas project to which the user belongs.
        :param roles: List that provides the pairings of one role with one applicable database.
        :param username: Human-readable label that represents the user that authenticates to MongoDB.
        :param awsiam_type: Human-readable label that indicates whether the new database user authenticates with the Amazon Web Services (AWS) Identity and Access Management (IAM) credentials associated with the user or the user's role.
        ...
        :param x509_type: Method that briefs who owns the certificate provided. If no value is given while using X509Type, Atlas uses the default value of MANAGED.
        '''
        if __debug__:
...
class CfnTeams(
    ...
    def attr_users(self) -> typing.List[typing.Any]:
        '''Attribute ``MongoDB::Atlas::Teams.Users``.'''
        return typing.cast(typing.List[typing.Any], jsii.get(self, "attrUsers"))
...
class CfnX509AuthenticationDatabaseUser(
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLinks")
    def attr_links(self) -> typing.List[typing.Any]:
        '''Attribute ``MongoDB::Atlas::X509AuthenticationDatabaseUser.Links``.'''
        return typing.cast(typing.List[typing.Any], jsii.get(self, "attrLinks"))

    @builtins.property
    @jsii.member(jsii_name="attrResults")
    def attr_results(self) -> typing.List[typing.Any]:
        '''Attribute ``MongoDB::Atlas::X509AuthenticationDatabaseUser.Results``.'''
        return typing.cast(typing.List[typing.Any], jsii.get(self, "attrResults"))
...
class DatabaseConfig:
    def __init__(
        ...
        *,
        ...
        :param match: A `$match <https://www.mongodb.com/docs/manual/reference/operator/aggregation/match>`_ expression filters change events. The trigger will only fire if the expression evaluates to true for a given change event.
    ...
    @builtins.property
    def match(self) -> typing.Any:
        '''A `$match <https://www.mongodb.com/docs/manual/reference/operator/aggregation/match>`_ expression filters change events. The trigger will only fire if the expression evaluates to true for a given change event.
