# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/05g_classification.baseline.baseline.ipynb.

# %% auto 0
__all__ = ['FastaiMetricWrapper', 'calculate_metrics', 'fixed_probs', 'random_probs']

# %% ../../../nbs/05g_classification.baseline.baseline.ipynb 1
from fastai.vision.all import *
from torch.utils.data import TensorDataset

# %% ../../../nbs/05g_classification.baseline.baseline.ipynb 3
...
# %% ../../../nbs/05g_classification.baseline.baseline.ipynb 4
...
# %% ../../../nbs/05g_classification.baseline.baseline.ipynb 8
def fixed_probs(x, y, n_classes, class_id):
    pred = torch.zeros(find_bs(y), n_classes).to(y.device)
    pred[:, class_id] = 1
    return pred

# %% ../../../nbs/05g_classification.baseline.baseline.ipynb 11
