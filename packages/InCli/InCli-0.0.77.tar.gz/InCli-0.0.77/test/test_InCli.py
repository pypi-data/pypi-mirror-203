...
#07L3O00000Dy7SAUAZ
    ...
    def test_log_file(self):
        try:
            res = InCli._main(["-logs","-inputfile",f"/Users/uormaechea/Documents/Dev/python/InCliLib/InCLipkg/InCli/logs/07L3O00000EBWAIUA5.log"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)
    ...
    def test_log_tail_auto_delete(self):
        try:
            #return
            InCli._main(["-u","NOSDEV","-logs","-tail","-auto","-deletelogs"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)  
