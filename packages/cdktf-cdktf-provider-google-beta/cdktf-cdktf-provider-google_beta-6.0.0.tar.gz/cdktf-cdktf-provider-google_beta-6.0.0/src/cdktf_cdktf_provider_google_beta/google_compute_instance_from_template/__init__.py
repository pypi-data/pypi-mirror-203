...
class GoogleComputeInstanceFromTemplateScratchDisk:
    def __init__(
        ...
        *,
        ...
        :param size: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_instance_from_template#size GoogleComputeInstanceFromTemplate#size}.
        '''
        if __debug__:
