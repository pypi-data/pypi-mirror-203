...
class GoogleBetaProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param network_security_custom_endpoint: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta#network_security_custom_endpoint GoogleBetaProvider#network_security_custom_endpoint}.
