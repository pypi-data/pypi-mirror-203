...
class GoogleComputeExternalVpnGateway(
    ...
    def __init__(
        ...
        *,
        ...
        :param labels: Labels for the external VPN gateway resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_external_vpn_gateway#labels GoogleComputeExternalVpnGateway#labels}
