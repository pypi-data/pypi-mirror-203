...
class GoogleVertexAiIndex(
    ...
    def __init__(
        ...
        *,
        ...
        :param region: The region of the index. eg us-central1. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_vertex_ai_index#region GoogleVertexAiIndex#region}
