...
class Dispatcher(aiogram.Dispatcher):
    ...
    def button(
        ...
        **kwargs,
        ...
        return self.callback_query_handler(
            button=button, state=state, chat_id=chat_id, user_id=user_id, **kwargs
        )
    ...
    def text(
        ...
        **kwargs,
        ...
        return self.message_handler(
            button=text, state=state, chat_id=chat_id, user_id=user_id, **kwargs
        )
