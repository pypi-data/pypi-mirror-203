"use strict";
(self["webpackChunk_quarto_jupyterlab_quarto"] = self["webpackChunk_quarto_jupyterlab_quarto"] || []).push([["lib_index_js"],{
...
function yamlPlugin(md, cb) {
    ...
    function frontMatter(state, startLine, endLine, silent) {
        let pos, nextLine, start_content, auto_closed = false, start = state.bMarks[startLine] + state.tShift[startLine], max = state.eMarks[startLine];
...
//# sourceMappingURL=lib_index_js.2f3c2800757da4bf48d0.js.map