...
class SEDASeqAltArchiveUnitArchiveUnitRefIdManagement(
    ...
    def description_level_concept(self):
        return (self.reverse_seda_description_level_from[0]
                if self.reverse_seda_description_level_from else None)
...
class SEDADescriptionLevel(generated.SEDADescriptionLevel):
    ...
    @property
    def concept(self):
        return self.seda_description_level_to[0] if self.seda_description_level_to else None
...
class SEDADataObjectGroup(generated.SEDADataObjectGroup):

    @property
    def simplified_profile(self):
        return self.seda_data_object_group[0].simplified_profile
