...
class seq_alt_archive_unit_archive_unit_ref_id_management_description_level_from(RelationDefinition):
...
class description_level_description_level_to(RelationDefinition):
    ...
    composite = fulltext_container = None
    inlined = True
    constraints = [RQLConstraint('O in_scheme CS, CS scheme_relation_type CR, CR name "seda_description_level_to"')]
...
class seq_alt_archive_unit_archive_unit_ref_id_management_agent_abstract(RelationDefinition):
...
class seq_alt_archive_unit_archive_unit_ref_id_management_transmitter(RelationDefinition):
...
class alt_agent_abstract_corpname_corpname(RelationDefinition):
    ...
    object = ('SEDAAltAgentAbstractCorpname', 'SEDAAltSenderCorpname', 'SEDAAltTransmitterCorpname')
    cardinality = '1?'
    composite = fulltext_container = 'object'
    inlined = True
    constraints = []
...
class alt_agent_abstract_corpname_seq_alt_agent_abstract_corpname_first_name(RelationDefinition):
...
class alt_transmitter_corpname_seq_alt_transmitter_corpname_first_name(RelationDefinition):
...
class seq_alt_agent_abstract_corpname_first_name_first_name(RelationDefinition):
    ...
    object = ('SEDASeqAltAgentAbstractCorpnameFirstName', 'SEDASeqAltSenderCorpnameFirstName', 'SEDASeqAltTransmitterCorpnameFirstName')
    cardinality = '1?'
    composite = fulltext_container = 'object'
    inlined = True
    constraints = []
