...
class SEDAFunction(SEDAAnyEntity):
    ...
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'function', 'user_annotation'])
    value_attr = 'function'

class SEDAActivity(SEDAAnyEntity):
    __regid__ = 'SEDAActivity'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'activity', 'user_annotation'])
    value_attr = 'activity'

class SEDAPosition(SEDAAnyEntity):
    __regid__ = 'SEDAPosition'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'position', 'user_annotation'])
    value_attr = 'position'

class SEDARole(SEDAAnyEntity):
    __regid__ = 'SEDARole'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'role', 'user_annotation'])
    value_attr = 'role'

class SEDAMandate(SEDAAnyEntity):
    __regid__ = 'SEDAMandate'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'mandate', 'user_annotation'])
    value_attr = 'mandate'
...
class SEDAFirstName(SEDAAnyEntity):
    ...
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'first_name', 'user_annotation'])
    value_attr = 'first_name'

class SEDABirthName(SEDAAnyEntity):
    __regid__ = 'SEDABirthName'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'birth_name', 'user_annotation'])
    value_attr = 'birth_name'

class SEDAFullName(SEDAAnyEntity):
    __regid__ = 'SEDAFullName'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'full_name', 'user_annotation'])
    value_attr = 'full_name'

class SEDAGivenName(SEDAAnyEntity):
    __regid__ = 'SEDAGivenName'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'given_name', 'user_annotation'])
...
class SEDABirthDate(SEDAAnyEntity):
    ...
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'birth_date', 'user_annotation'])
...
class SEDADeathDate(SEDAAnyEntity):
    ...
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'death_date', 'user_annotation'])
...
class SEDAAddress(SEDAAnyEntity):
    ...
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'address', 'user_annotation'])
    value_attr = 'address'

class SEDACity(SEDAAnyEntity):
    __regid__ = 'SEDACity'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'city', 'user_annotation'])
    value_attr = 'city'

class SEDACountry(SEDAAnyEntity):
    __regid__ = 'SEDACountry'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'country', 'user_annotation'])
    value_attr = 'country'

class SEDAGeogname(SEDAAnyEntity):
    __regid__ = 'SEDAGeogname'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'geogname', 'user_annotation'])
    value_attr = 'geogname'

class SEDAPostalCode(SEDAAnyEntity):
    __regid__ = 'SEDAPostalCode'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'postal_code', 'user_annotation'])
    value_attr = 'postal_code'

class SEDARegion(SEDAAnyEntity):
    __regid__ = 'SEDARegion'
    fetch_attrs, cw_fetch_order = fetch_config(['user_cardinality', 'region', 'user_annotation'])
    value_attr = 'region'
