...
class GPF:
    ...
    def train(
        ...
        """
        _, val_x = self.split_train_val(self.train_x, self.groups["h"] * 2)
        train_y_split, val_y = self.split_train_val(self.train_y, self.groups["h"] * 2)
    ...
    def validate(
        self, model: IndependentModelList, val_x, val_y, train_y, likelihood
    ) -> float:
        """
        Validate the model.
