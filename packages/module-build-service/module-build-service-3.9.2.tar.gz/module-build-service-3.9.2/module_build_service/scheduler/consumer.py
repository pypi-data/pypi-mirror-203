...
@contextmanager
def set_current_module_build_id(build_id):
    """Context manager to temporarily set the module build ID - this is
    needed to get logging to go to the right build log.
    """
    MBSConsumer.current_module_build_id = build_id
    try:
        yield
    finally:
