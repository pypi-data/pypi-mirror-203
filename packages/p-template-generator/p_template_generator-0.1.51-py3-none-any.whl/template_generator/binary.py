...
def checkFileMd5(rootDir):
    data = {
        "fonts.zip.py" : "f2248807ca3d79cd9aa1fd837057aaf9",
...
def updateBin(rootDir):
    ...
    getOssResource(rootDir, "http://mecord-m.2tianxin.com/res/skymedia_20230417.zip", "80608b7f366153e112173d231bcfcd59", "skymedia.zip.py")
