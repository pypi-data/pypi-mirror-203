...
class test(unittest.TestCase):
    ...
    def testAppend(self):
        ...
        dat5 = SheetsFromFile('testData/data5.xlsx', 'A-B')
    ...
    def testsSheets(self):
        ...
        np.testing.assert_array_equal(sheet.c.value, [7,8,9,10])
        self.assertEqual(sheet.c.unit, 'Hz')
        np.testing.assert_array_equal(sheet.d.value, [11,12,13,14])
        self.assertEqual(sheet.d.unit, 'L')
        np.testing.assert_array_equal(sheet.e.value, [15,16,17,18])
        ...
        np.testing.assert_array_equal(sheets[1].c.value, [7,8,9,10])
        self.assertEqual(sheets[1].c.unit, 'Hz')
        np.testing.assert_array_equal(sheets[1].d.value, [11,12,13,14])
