...
def filt_worker_ovs(data: np.array = None, pos_ini=0, pos_end=0, b: np.array = None):
    """
...
def filt_filt_worker_ovs(data: np.array = None, pos_ini=0, pos_end=None, b: np.array = None):
    """
    Overlap saving filtering worker. This function filter part of input data. Filter coefficients are assumed to be
    from an FIR filter
    :param data: mxn matrix to be filtered
