...
def get_admin_customer_properties(
    idOrShortName: str,
    domain: str = None,
    key: str = None,
    limit: int = 25,
...
def get_admin_customer_user_roles(
    idOrShortName: str,
    domain: str = None,
    json: bool = True,
    verify: Optional[bool] = None,
...
def remove_admin_customer_properties(
    idOrShortName: str,
    key: str,
    domain: str = None,
    json: bool = True,
...
def update_admin_customer_logo(
    idOrShortName: str,
    domain: str = None,
    image: str = None,
    mimeType: str = None,
...
def update_admin_customer_properties(
    idOrShortName: str,
    domain: str = None,
...
def update_admin_customer_user_roles(
    idOrShortName: str,
    domain: str = None,
    userRoles: dict = None,
    json: bool = True,
